...
<div style="width: 80%;margin: auto;padding-bottom: 50px;border-bottom: 2px solid #ccc;">
    ...
    <div class="btn-group" style="margin-left: 35px;margin-top: 10px;">
        <button class="btn btn-secondary" onclick="window.location.href='appointment-tenant-list'">Danh sách</button>
        <button class="btn btn-primary" onclick="window.location.href='calender-appointment.jsp'">Lịch</button>
    </div>
</div>
...
<div id="calendar" style="width: 80%;margin: auto;margin-top: 50px;margin-bottom: 80px;"></div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var events = appointmentList.map(function(appointment) {
                            ...
                            var host = hostList.find(function(ho) {
                                return ho.id === appointment.hostId;
                            });

                            var homeName = home ? home.name : "Không có tên nhà";
            ...
            eventClick: function(info) {
                ...
                var roomName = event.extendedProps.roomName;
                var address = event.extendedProps.address;
                var hostName = event.extendedProps.hostName;
                var phone = event.extendedProps.phone;
                var email = event.extendedProps.email;
                var note = event.extendedProps.note;
                ...
                document.getElementById('pHostName').textContent = hostName || "Không có thông tin";
