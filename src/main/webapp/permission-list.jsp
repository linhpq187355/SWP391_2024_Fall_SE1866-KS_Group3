                                        ...
                                        <c:forEach items="${requestScope.userList}" var="user">
                                            <tr>
                                                ...
                                                <td class="space-y-4 text-center">
                                                    ...
                                                    <a href="permission-update?userId=${user.id}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><i class="fas fa-hashtag"></i>  <strong>UID:</strong> <span id="userId"></span></p>
                <p><i class="fas fa-envelope"></i>  <strong>Email:</strong> <span id="userEmail"></span></p>
                <p><i class="fas fa-id-badge"></i>  <strong>Vai trò:</strong> <span id="userRole"></span></p>
                <p><i class="fas fa-signal"></i>  <strong>Trạng thái:</strong> <span id="userStatus"></span></p>
                <p><i class="fas fa-phone"></i>  <strong>SĐT:</strong> <span id="userPhoneNum"></span></p>
                <p><i class="fas fa-map"></i>  <strong>Địa chỉ:</strong> <span id="userAddress"></span></p>
            </div>
